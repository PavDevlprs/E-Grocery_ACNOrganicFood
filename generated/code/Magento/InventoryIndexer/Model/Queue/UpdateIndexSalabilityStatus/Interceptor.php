...
class Interceptor extends \Magento\InventoryIndexer\Model\Queue\UpdateIndexSalabilityStatus implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\InventoryCatalogApi\Api\DefaultStockProviderInterface $defaultStockProvider, \Magento\InventoryIndexer\Model\Queue\UpdateIndexSalabilityStatus\IndexProcessor $indexProcessor, \Magento\InventoryIndexer\Model\Queue\UpdateIndexSalabilityStatus\UpdateLegacyStock $updateLegacyStock)
    {
        $this->___init();
        parent::__construct($defaultStockProvider, $indexProcessor, $updateLegacyStock);
    }
