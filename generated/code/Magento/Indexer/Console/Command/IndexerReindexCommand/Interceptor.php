...
class Interceptor extends \Magento\Indexer\Console\Command\IndexerReindexCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\ObjectManagerFactory $objectManagerFactory, ?\Magento\Framework\Indexer\IndexerRegistry $indexerRegistry = null, ?\Magento\Framework\Indexer\Config\DependencyInfoProvider $dependencyInfoProvider = null, ?\Magento\Indexer\Model\Processor\MakeSharedIndexValid $makeSharedValid = null)
    {
        $this->___init();
        parent::__construct($objectManagerFactory, $indexerRegistry, $dependencyInfoProvider, $makeSharedValid);
    }
