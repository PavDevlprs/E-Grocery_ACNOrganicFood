...
class Interceptor extends \Dotdigitalgroup\Email\Model\ResourceModel\Catalog\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getProductsToProcess($limit)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProductsToProcess', func_get_args(), $pluginInfo) : parent::getProductsToProcess($limit);
    }
    ...
    public function filterProductsByStoreTypeAndVisibility($storeId, $productIds)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('filterProductsByStoreTypeAndVisibility', func_get_args(), $pluginInfo) : parent::filterProductsByStoreTypeAndVisibility($storeId, $productIds);
    }
